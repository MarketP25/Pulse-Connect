...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-indigo-100 via-white to-indigo-200
      ...
      <div className="w-full max-w-2xl space-y-6">
        ...
        <div className="bg-white shadow-sm border rounded-lg p-4 sm:p-5">
          ...
          <div className="inline-block px-2 py-1 sm:px-3 sm:py-1 bg-indigo-50 border border-indigo-200
