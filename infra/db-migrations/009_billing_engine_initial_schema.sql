...
CREATE TABLE subscriptions (
    ...
    status VARCHAR(20) NOT NULL, -- e.g., 'active', 'cancelled', 'past_due'
...
CREATE TABLE billing_ledger (
    ...
    marp_policy_version VARCHAR(50) NOT NULL,
...
VALUES
    ('Founders Launch Discount', '20% off subscriptions for the first 500 Enterprise users', 20.00, 'SUBSCRIPTION', true),
