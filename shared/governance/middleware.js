...
const governanceGuard = (subsystem) => {
    return async (req, res, next) => {
        ...
        if ((0, global_governance_state_1.getGlobalGovernanceStatus)() === "DEGRADED") {
            ...
            console.warn(`[GovernanceGuard] Request throttled due to DEGRADED state for ${throttleDelayMs}ms.`);
        }
            ...
            switch (decision.action) {
                ...
                case "CHALLENGE_DUAL_CONTROL":
                    ...
                    try {
                        ...
                        const isAttestationValid = (0, crypto_utils_1.verifySignature)(payloadHash, attestation, MARP_PUBLIC_KEY);
