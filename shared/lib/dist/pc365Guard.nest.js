...
/**
 * NestJS Guard implementation of PC365 Dual Control
 */
let PC365Guard = (() => {
    ...
    let _classThis;
    var PC365Guard = _classThis = class {
        constructor() {
            this.baseGuard = new pc365Guard_1.PC365Guard({
        ...
        canActivate(context) {
            ...
            try {
                return this.baseGuard.validateDestructiveAction({
    ...
    __setFunctionName(_classThis, "PC365Guard");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        PC365Guard = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PC365Guard = _classThis;
})();
exports.PC365Guard = PC365Guard;
//# sourceMappingURL=pc365Guard.nest.js.map