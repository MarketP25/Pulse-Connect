...
export class ReportingController {
  ...
  @Get("revenue/trends")
  async getRevenueTrends(@Query("period") period: string, @Query("region") region?: string) {
  ...
  @Get("fraud/anomalies")
  async getFraudAnomalies(@Query("region") region?: string, @Query("window") window?: string) {
