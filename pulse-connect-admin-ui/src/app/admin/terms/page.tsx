...
export default function AdminTerms() {
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <h1 className="text-3xl font-bold">Pulsco Admin Terms and Conditions</h1>

      <div className="prose prose-blue max-w-none">
        <h2 className="text-xl font-semibold text-red-600">🚨 Important Notice</h2>
        <p className="text-gray-700">
          As an administrator of Pulsco, you are being granted significant privileges and
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>Your admin code grants full access to Pulsco systems</li>
