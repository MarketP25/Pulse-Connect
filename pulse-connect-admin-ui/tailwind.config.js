  ...
  plugins: [
    ...
    function ({ addComponents, theme }) {
      const components = {
        // Buttons
        '.btn-primary': {
          '@apply': 'inline-flex items-center justify-center px-md py-sm bg-pulse-cyan-500 text-orbit-blue-600 font-semibold rounded-md hover:bg-pulse-cyan-400 active:bg-pulse-cyan-600 transition-colors duration-normal disabled:opacity-50 disabled:cursor-not-allowed',
        },
        '.btn-secondary': {
          '@apply': 'inline-flex items-center justify-center px-md py-sm border-2 border-pulse-cyan-500 text-pulse-cyan-500 font-semibold rounded-md hover:bg-pulse-cyan-500 hover:bg-opacity-10 transition-colors duration-normal disabled:opacity-50 disabled:cursor-not-allowed',
        },
        '.btn-tertiary': {
        ...
        '.btn-ghost': {
          '@apply': 'inline-flex items-center justify-center px-md py-sm text-tech-white font-medium rounded-md hover:bg-nebula-800 transition-colors duration-normal disabled:opacity-50 disabled:cursor-not-allowed',
        },
        '.btn-danger': {
        ...
        // Cards
        '.card': {
          '@apply': 'bg-nebula-800 border border-nebula-500 rounded-lg p-lg shadow-md hover:shadow-lg transition-all duration-normal',
        },
        '.card-elevated': {
          '@apply': 'bg-nebula-800 border border-nebula-500 rounded-lg p-lg shadow-lg hover:shadow-xl transition-all duration-normal',
        },
