  ...
  plugins: [
    ...
    function ({ addComponents, theme }) {
      const components = {
        ...
        ".btn-primary": {
          "@apply":
            "inline-flex items-center justify-center px-md py-sm bg-[var(--brand-primary)] text-[var(--brand-background)] font-semibold rounded-md hover:bg-[var(--brand-accent)] active:bg-[var(--brand-primary)] transition-all duration-normal transform hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:scale-100"
        },
        ".btn-secondary": {
          "@apply":
            "inline-flex items-center justify-center px-md py-sm border-2 border-[var(--brand-primary)] text-[var(--brand-primary)] font-semibold rounded-md hover:bg-[var(--brand-primary)] hover:bg-opacity-10 transition-all duration-normal disabled:opacity-50 disabled:cursor-not-allowed"
        },
        ".btn-tertiary": {
          "@apply":
            "inline-flex items-center justify-center px-md py-sm bg-nebula-800 text-tech-white font-medium rounded-md hover:bg-nebula-700 transition-colors duration-normal disabled:opacity-50 disabled:cursor-not-allowed"
        },
        ".btn-action": {
          "@apply":
            "inline-flex items-center justify-center px-md py-sm bg-gradient-pulse text-white font-semibold rounded-md hover:shadow-[0_0_15px_var(--brand-glow-mid)] transition-all duration-normal disabled:opacity-50 disabled:cursor-not-allowed"
        },
        ".btn-danger": {
          "@apply":
            "inline-flex items-center justify-center px-md py-sm bg-critical text-white font-semibold rounded-md hover:bg-opacity-90 transition-all duration-normal disabled:opacity-50 disabled:cursor-not-allowed"
        },
        ".btn-success": {
          "@apply":
            "inline-flex items-center justify-center px-md py-sm bg-success text-white font-semibold rounded-md hover:bg-opacity-90 transition-all duration-normal disabled:opacity-50 disabled:cursor-not-allowed"
        },

        // Cards with more engagement
        ".card": {
          "@apply":
            "bg-nebula-800 border border-nebula-500 rounded-lg p-lg shadow-md hover:shadow-lg transition-all duration-normal hover:border-[var(--brand-primary)]"
        },
        ".card-hover": {
          "@apply":
            "card cursor-pointer hover:translate-y-[-2px] hover:shadow-[0_0_10px_var(--brand-glow-low)]"
        },

        // Input Fields
        ".input-base": {
          "@apply":
            "w-full bg-nebula-900 border border-nebula-500 rounded-md px-md py-sm text-body text-tech-white placeholder-nebula-500 focus:border-pulse-cyan-500 focus:ring-2 focus:ring-pulse-cyan-500 focus:ring-opacity-20 transition-all duration-normal"
        },
        ...
        ".badge-primary": {
          "@apply": "badge bg-[var(--brand-primary)] bg-opacity-20 text-[var(--brand-primary)]"
        },
        ".badge-success": {
